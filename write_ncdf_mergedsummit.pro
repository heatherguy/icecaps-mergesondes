...
;
;to run:
;    daysofayear_yyyymmdd,2011,doy2011
;    for i=0,n_elements(doy2011)-1 do write_ncdf_mergedsummit,doy2011[i]
;
;
pro write_ncdf_mergedsummit,yyyymmdd


create_mergedsummitprofiles,yyyymmdd,height,t_interp,temp_merge,mixr_merge,pres_merge,$
...
if keyword_set(t_interp) then begin ; will be set if there is a ecmwf file for that day
...
endif else print,'no ecmwf data for the day or the day before. skipping . . .'
