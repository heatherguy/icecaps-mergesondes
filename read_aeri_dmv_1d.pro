;+
; $Id: read_aeri_dmv_1d.pro,v 1.1 2008/05/20 13:19:27 dturner Exp $
;
; Abstract:
;	This routine read in a 1-dimensional field from the binary DMV datafiles
...
;
function read_aeri_dmv_1d, $		; Returns a structure with the data
...
;-
  ...
  dim = 0
  readf,lun,dim
  if(dim ne 1) then begin
    print,'Error: the field '+fieldname+' is not a 1-d array in '+filename
    return,0
  endif
  readf,lun,dim
  data = fltarr(dim)
