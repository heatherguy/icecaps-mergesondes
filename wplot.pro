...
;
; $Author: d3h797 $
; $Date: 1997/12/04 16:36:47 $
; $Id: wplot.pro,v 1.1 1997/12/04 16:36:47 d3h797 Release_ddt_1_13 $
; $Log: wplot.pro,v $
; Revision 1.1  1997/12/04 16:36:47  d3h797
; Initial revision
;
...
;
;
pro wplot_create_gui, tlb_id, win_id
;
;
...
; --------------------------------------------
  ...
  dw_id = widget_info( event.id, /child )
  widget_control, dw_id, get_value = win_id
  wset, win_id

  widget_control, dw_id, xsize = event.x, $
                         ysize = event.y
...
;   --------------------------
    ...
    wplot_create_gui, tlb_id, win_id
...
; -----------------------
  ...
  dw_id = widget_info( tlb_id, /child )
